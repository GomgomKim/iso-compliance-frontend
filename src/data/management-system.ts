...
export const managementClauses: ManagementClause[] = [
  ...
  },
  {
    ...
    descriptionKo: "심사를 받을 범위를 명확히 글과 그림으로 정의합니다. (전사가 아닌 'SaaS 서비스'로 한정하는 것이 유리합니다.)",
    tip: "1. 문구 작성: \"인증 범위는 '클라이원트 SaaS 서비스 개발 및 운영'으로 한정한다.\"\n2. 망 구성도 그리기: PPT나 Figma로 간단한 네트워크 구성도를 그립니다.\n   - AWS VPC 안에 Web Server, WAS, DB 등을 그립니다.\n   - 이 전체를 감싸는 빨간 점선 박스를 치고 \"ISMS 인증 범위\"라고 적습니다.\n3. 증적 저장: 범위가 표시된 네트워크 구성도 이미지.",
    evidence: "인증 범위 정의서",
  },
  {
    id: "4.4",
